...
export (String, FILE) var Ubu_level_scene
...
func _ready():
	...
	$Level_Select_Menu/Button_Level_Ubu.connect("pressed", self, "level_select_menu_button_pressed", ["Ubu_level"])
...
func level_select_menu_button_pressed(button_name):
	...
	elif button_name == "Ubu_level":
		set_mouse_and_joypad_sensitivity()
		get_node("/root/Globals").load_new_scene(Ubu_level_scene)
		get_tree().change_scene("res://assets/Ubu_Scene/ubu.tscn")
